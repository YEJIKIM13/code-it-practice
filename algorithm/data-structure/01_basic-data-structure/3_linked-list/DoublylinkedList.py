...
class LinkedList:
    ...
    def delete(self, node_to_delete):
        ...
        if self.head == self.tail:
            self.head = None
            self.tail = None
        # 지우려는 노드가 헤드 노드인데 마지막 남은 노드는 아닌 경우
        elif node_to_delete.prev is None and node_to_delete.next is not None:
            self.head = self.head.next
            self.head.prev = None
        # 지우려는 노드가 테일 노드인데 마지막 남은 노드는 아닌 경우
        elif node_to_delete == self.tail and node_to_delete.prev is not None:
